JAZZMIN_SETTINGS = {
    ...
    "user_menu": [
        {"name": "Procfile", "url": "admin:auth_user_change", "icon": "user", "permissions": ["auth.change_user"]},
        ...
        {"name": "Settings", "url": "admin:core_setting_changelist", "icon": "cog", "permissions": ["aut.change_user"]},
        {"name": "Log Out", "url": "admin:logout", "icon": "sign-out-alt"},
    ],
    "user_menu_links": [
        {"name": "Project Admin", "url": " ", "icon": "link"},
    ],
    "icon": {
    ...
    "default-icon_parents": "fas fa-chevron-circle-right",
    ...
    "fieldsets": [
        ...
        ("Menu Options", {"fields": ["related_model_active", "show_ui_builder", "changeform_format"]}),
